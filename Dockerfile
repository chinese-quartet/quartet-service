...
LABEL org.opencontainers.image.source https://github.com/chinese-quartet/quartet-service
...
# Add quartet-service script and uberjar
RUN mkdir -p bin target/uberjar
COPY --from=builder /app/source/target/uberjar/quartet-service.jar /app/target/uberjar/
